...
buen_gobierno_edit1 <- buen_gobierno_edit %>%
  left_join(suma_por_depto_gob, by = c("coddepto", "ano")) %>%
...
conflicto_violencia_edit1 <- conflicto_violencia_edit %>%
  left_join(suma_por_depto_coca, by = c("coddepto", "ano")) %>%
...
educacion_edit3 <- educacion_edit2 %>%
  left_join(suma_por_depto_educ, by = c("coddepto", "ano")) %>%
