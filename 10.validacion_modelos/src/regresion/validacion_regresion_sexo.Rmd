...
conteos_sexo_ant1 <- violencias_artificial_nas_1 %>%
	...
	summarise(n_class= n()) %>%
	mutate(regresion = "sexo_regresion1") %>%
	ungroup() %>%
	group_by(violencia) %>%
...
conteos_sexo_ant2 <- violencias_artificial_nas_2 %>%
	...
	group_by(categoria, violencia) %>%
	summarise(n_class= n()) %>%
	mutate(regresion = "sexo_regresion2") %>%
	ungroup() %>%
	group_by(violencia) %>%
	mutate(N = sum(n_class))
...
conteos_sexo_ant3 <- violencias_artificial_nas_3 %>%
	...
	group_by(categoria, violencia) %>%
	summarise(n_class= n()) %>%
	mutate(regresion = "sexo_regresion3") %>%
	ungroup() %>%
	group_by(violencia) %>%
	mutate(N = sum(n_class))
...
conteos_sexo_ant4 <- violencias_artificial_nas_4 %>%
	...
	group_by(categoria, violencia) %>%
	summarise(n_class= n()) %>%
	mutate(regresion = "sexo_regresion4") %>%
	ungroup() %>%
	group_by(violencia) %>%
	mutate(N = sum(n_class))
...
conteos_sexo_ant5 <- violencias_artificial_nas_5 %>%
	...
	group_by(categoria, violencia) %>%
	summarise(n_class= n()) %>%
	mutate(regresion = "sexo_regresion5") %>%
	ungroup() %>%
	group_by(violencia) %>%
	mutate(N = sum(n_class))
