...
# Calcular WAI y WRAI
calcular_impacto <- function(regresion_cols, observaciones, datos) {
  wai <- sapply(regresion_cols, function(col) sum(datos[[col]] - datos[[observaciones]]))
  wrai <- sapply(regresion_cols, function(col) sum(datos[[col]] - datos[[observaciones]]) / sum(datos[[observaciones]]))
...
# Columnas de regresions y observaciones para mujeres
regresion_cols_mujeres <- paste0("mujeres_regresion", 1:5)
observaciones_mujeres <- "mujeres_obs"

# Columnas de regresions y observaciones para hombres
regresion_cols_hombres <- paste0("hombres_regresion", 1:5)
...
agregados_comparacion_desap <- comparacion_desap %>%
  ...
  summarise(
    ...
    hombres_regresion1 = sum(sexo_regresion1 == "HOMBRE"),
    mujeres_regresion1 = sum(sexo_regresion1 == "MUJER"),
    hombres_regresion2 = sum(sexo_regresion2 == "HOMBRE"),
    mujeres_regresion2 = sum(sexo_regresion2 == "MUJER"),
    hombres_regresion3 = sum(sexo_regresion3 == "HOMBRE"),
    mujeres_regresion3 = sum(sexo_regresion3 == "MUJER"),
    hombres_regresion4 = sum(sexo_regresion4 == "HOMBRE"),
    mujeres_regresion4 = sum(sexo_regresion4 == "MUJER"),
    hombres_regresion5 = sum(sexo_regresion5 == "HOMBRE"),
    mujeres_regresion5 = sum(sexo_regresion5 == "MUJER")
  ) %>%
  arrange(yy_hecho)
```
...
impacto_mujeres_desap <- calcular_impacto(regresion_cols_mujeres, observaciones_mujeres, agregados_comparacion_desap)

print(impacto_mujeres_desap$wai)
print(impacto_mujeres_desap$mean_wai) 
print(impacto_mujeres_desap$wrai)
print(impacto_mujeres_desap$mean_wrai) 


#impacto para hombres
impacto_hombres_desap <- calcular_impacto(regresion_cols_hombres, observaciones_hombres, agregados_comparacion_desap)

print(impacto_hombres_desap$wai)
print(impacto_hombres_desap$mean_wai)
print(impacto_hombres_desap$wrai)
print(impacto_hombres_desap$mean_wrai) 
```
...
# Impacto para mujeres
impacto_mujeres_homi <- calcular_impacto(regresion_cols_mujeres, observaciones_mujeres, agregados_comparacion_homi)

print(impacto_mujeres_homi$wai)
print(impacto_mujeres_homi$mean_wai) 
print(impacto_mujeres_homi$wrai)
print(impacto_mujeres_homi$mean_wrai)

#impacto para hombres
impacto_hombres_homi <- calcular_impacto(regresion_cols_hombres, observaciones_hombres, agregados_comparacion_homi)

print(impacto_hombres_homi$wai)
print(impacto_hombres_homi$mean_wai)
print(impacto_hombres_homi$wrai)
print(impacto_hombres_homi$mean_wrai) 
```
...
# Impacto para mujeres
impacto_mujeres_reclu <- calcular_impacto(regresion_cols_mujeres, observaciones_mujeres, agregados_comparacion_reclu)

print(impacto_mujeres_reclu$wai)
print(impacto_mujeres_reclu$mean_wai) 
print(impacto_mujeres_reclu$wrai)
print(impacto_mujeres_reclu$mean_wrai) 


#impacto para hombres
impacto_hombres_reclu <- calcular_impacto(regresion_cols_hombres, observaciones_hombres, agregados_comparacion_reclu)

print(impacto_hombres_reclu$wai)
print(impacto_hombres_reclu$mean_wai)
print(impacto_hombres_reclu$wrai)
print(impacto_hombres_reclu$mean_wrai) 
```
...
# Impacto para mujeres
impacto_mujeres_secue <- calcular_impacto(regresion_cols_mujeres, observaciones_mujeres, agregados_comparacion_secue)

print(impacto_mujeres_secue$wai)
print(impacto_mujeres_secue$mean_wai) 
print(impacto_mujeres_secue$wrai)
print(impacto_mujeres_secue$mean_wrai) 


#impacto para hombres
impacto_hombres_secue <- calcular_impacto(regresion_cols_hombres, observaciones_hombres, agregados_comparacion_secue)

print(impacto_hombres_secue$wai)
print(impacto_hombres_secue$mean_wai)
print(impacto_hombres_secue$wrai)
print(impacto_hombres_secue$mean_wrai) 
```
