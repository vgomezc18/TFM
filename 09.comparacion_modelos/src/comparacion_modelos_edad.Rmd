...
```{r}
donante_edad_jep_desap <- rbind(imputacion_donante_edad_jep[["desaparicion_1996_2000"]], 
...
donante_edad_jep_homi <- rbind(imputacion_donante_edad_jep[["homicidio_1996_2000"]], 
			imputacion_donante_edad_jep[["homicidio_2001_2005"]],
			imputacion_donante_edad_jep[["homicidio_2006_2010"]],
			imputacion_donante_edad_jep[["homicidio_2011_2016"]])

donante_edad_jep_secue <- rbind(imputacion_donante_edad_jep[["secuestro_1996_2000"]], 
...
donante_edad_jep_reclu <- rbind(imputacion_donante_edad_jep[["reclutamiento_1996_2000"]], 
...
plot_desap_adolescencia_year_imp <- adolescencia_proyecto_desap %>%
    ...
    theme(axis.text.x = element_text(size = 11, angle = 90),
        ...
        axis.ticks.x = element_line(size = 0.1)) +
    scale_x_continuous(breaks = seq(1980, 2016, 2)) +
		scale_y_continuous(breaks = seq(0, max(adolescencia_proyecto_desap$imp_donante,
																				 na.rm = TRUE), by = 100)) +
    theme(legend.position = "bottom") +
    labs(x = "Año",
...
plot_homi_adolescencia_year_imp <- adolescencia_proyecto_homi %>%
    ...
    theme(axis.text.x = element_text(size = 11, angle = 90),
        ...
        axis.ticks.x = element_line(size = 0.1)) +
    scale_x_continuous(breaks = seq(1980, 2016, 2)) +
		scale_y_continuous(breaks = seq(0, max(adolescencia_proyecto_homi$imp_donante,
																				 na.rm = TRUE), by = 200)) +
    theme(legend.position = "bottom") +
    labs(x = "Año",
         y = "Número de víctimas en la adolescencia (de 15 a 19 años)",
...
plot_secue_adolescencia_year_imp <- adolescencia_proyecto_secue %>%
    ...
    theme(axis.text.x = element_text(size = 11, angle = 90),
        ...
        axis.ticks.x = element_line(size = 0.1)) +
    scale_x_continuous(breaks = seq(1980, 2016, 2)) +
		scale_y_continuous(breaks = seq(0, max(adolescencia_proyecto_secue$imp_donante,
																				 na.rm = TRUE), by = 50)) +
    theme(legend.position = "bottom") +
    labs(x = "Año",
         y = "Número de víctimas en la adolescencia (de 15 a 19 años)",
