...
```{r}
donante_p_str_desap <- rbind(imputacion_donante_p_str[["desaparicion_1996_2000"]], 
...
donante_p_str_homi <- rbind(imputacion_donante_p_str[["homicidio_1996_2000"]], 
			imputacion_donante_p_str[["homicidio_2001_2005"]],
...
donante_p_str_secue <- rbind(imputacion_donante_p_str[["secuestro_1996_2000"]], 
...
donante_p_str_reclu <- rbind(imputacion_donante_p_str[["reclutamiento_1996_2000"]], 
...
plot_desap_perp_imp <- ggplot(tabla_combinada_desaparicion,
  ...
  scale_y_continuous(labels = function(n){format(n, scientific = FALSE)}) +
	scale_y_continuous(breaks = seq(0, max(tabla_combinada_desaparicion$imp_hi,
																				 na.rm = TRUE), by = 10000)) +
  theme_minimal() +
...
plot_homi_perp_imp <- ggplot(tabla_combinada_homicidio,
  ...
  geom_point(aes(y = imp_donante, color = "Imputado por donante", shape = "Imputado por donante"), 
             fill = "red", size = 1, stroke = 1.1, show.legend = TRUE) +
  scale_y_continuous(labels = function(n){format(n, scientific = FALSE)}) +
	scale_y_continuous(breaks = seq(0, max(tabla_combinada_homicidio$imp_hi,
																				 na.rm = TRUE), by = 20000)) +
  theme_minimal() +
  theme(legend.title = element_text(size = 6, face = "bold"),
        legend.text = element_text(size = 9, face = "bold"),
...
plot_secue_perp_imp <- ggplot(tabla_combinada_secuestro,
  ...
  geom_point(aes(y = imp_donante, color = "Imputado por donante", shape = "Imputado por donante"), 
             fill = "red", size = 1, stroke = 1.1, show.legend = TRUE) +
  scale_y_continuous(labels = function(n){format(n, scientific = FALSE)}) +
	scale_y_continuous(breaks = seq(0, max(tabla_combinada_secuestro$imp_hi,
																				 na.rm = TRUE), by = 2500)) +
  theme_minimal() +
  theme(legend.title = element_text(size = 6, face = "bold"),
        legend.text = element_text(size = 9, face = "bold"),
...
plot_reclu_perp_imp <- ggplot(tabla_combinada_reclutamiento,
  ...
  geom_point(aes(y = imp_donante, color = "Imputado por donante", shape = "Imputado por donante"), 
             fill = "red", size = 1, stroke = 1.1, show.legend = TRUE) +
  scale_y_continuous(labels = function(n){format(n, scientific = FALSE)}) +
	scale_y_continuous(breaks = seq(0, max(tabla_combinada_reclutamiento$imp_hi,
																				 na.rm = TRUE), by = 1000)) +
  theme_minimal() +
  theme(legend.title = element_text(size = 6, face = "bold"),
        legend.text = element_text(size = 9, face = "bold"),
